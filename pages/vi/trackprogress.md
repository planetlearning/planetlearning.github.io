 ...
 * Remember, in order to complete the ["First Steps"](firststeps.md) you need:
    * 1 valid PRs in planetlearning.github.io
...
<script>
    ...
    function Total_PRs() {
        var url = "https://api.github.com/search/issues?q=repo:planetlearning/planetlearning.github.io+author:" + user + "+type:pr&sort=created&order=asc";
        fetch(url)
            .then(checkStatus)
            .then((resp) => resp.json())
            .then(function(data) {
    ...
    function Total_PRs() {
        var url = "https://api.github.com/search/issues?q=repo:planetlearning/planetlearning.github.io+commenter:" + user + "+type:comment&sort=created&order=asc";
        fetch(url)
            .then(checkStatus)
            .then((resp) => resp.json())
            .then(function(data) {
    ...
    function Total_Issues() {
        var url = "https://api.github.com/search/issues?q=repo:planetlearning/planetlearning.github.io+author:" + user + "+type:issue&sort=created&order=asc";
        fetch(url)
            .then(checkStatus)
            .then((resp) => resp.json())
            .then(function(data) {
    ...
    function Merged_PRs() {
        var url = "https://api.github.com/search/issues?q=repo:planetlearning/planetlearning.github.io+author:" + user + "+is:merged&sort=created&order=asc";
        fetch(url)
            .then(checkStatus)
            .then((resp) => resp.json())
            .then(function(data) {
