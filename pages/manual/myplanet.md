...
On the resulting screen, enter the local server IP Address in the form of a URL. URL will be what you open on your browser to use planet. Unless you received special instructions, enter: http://192.168.2.1. Also, enter the Pin from Step 1 above
